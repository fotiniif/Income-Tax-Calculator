...
public class TaxpayerManager {
  ...
  private void updateFiles(int taxRegistrationNumber) throws IOException{
   TaxpayerUpdateFactory factory = new TaxpayerUpdateFactory();
   factory.updateTaxpayer(taxRegistrationNumber);
  }

  public void saveLogFile(String taxRegistrationNumber, String fileFormat) throws IOException, WrongFileFormatException {
    LogFileFactory factory = new LogFileFactory();
    factory.generateLogFile(fileFormat).generateFile(taxRegistrationNumber, 0);
  }
  ...
  public void loadTaxpayer(String fileName)
    ...
    factory.generateFileReaders(fileName).readFile(fileName);
  }
